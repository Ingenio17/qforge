...
-   **Acknowledgments**: Updated `README.md` with explicit credit to scqubits and QuTiP.
...
- **Export Functionality**: Export quantum systems to and QuTiP formats for integration with external tools
